...
$getAlmacenStocks=getAlmacenStocks($idx,$ifecha,$ffecha);

echo "<h3>REPORTE CANTIDAD DE STOCK EN ALMACEN <br>Consulta realizada del: ".$ifecha." al ".$ffecha."</h3>"; 
...
foreach($getAlmacenStocks as $getAlmacenStock): 
 	{			
	
	 
	 			echo '<tr>
                        <td>'.$numero.'</td>
                        <td>'.$getAlmacenStock['aProducto'].'</td>
                        <td>'.$getAlmacenStock['aCantidad'].'</td>
                        
                        <td>'.$getAlmacenStock['aFecha'].'</td>
                        <td>'.$getAlmacenStock['aUnidadMedida'].'</td>
						</tr>';
 	}
 endforeach; 
echo '</table>';
