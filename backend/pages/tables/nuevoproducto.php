                                ...
                                <form action="insertarproducto.php" method="POST">
                                 <div class="form-group">
                                  <div class="col-xs-12">
                                    ...
                                    <input type="text" class="form-control" name="pDescripcion" id="pDescripcion">
                                    <br>
                                    ...
                                    <input type="text" class="form-control" name="pFamilia" id="pFamilia">
                                    <br>

                                    <label for="producto">Imagen </label>
                                    <input type="text" class="form-control" name="pImg" id="pImg">
                                    <br>

                                    <label for="producto">Imagen Pequeña </label>
                                    <input type="text" class="form-control" name="pThumb" id="pThumb">
                                    <br>

                                    <label for="producto">Carta </label>
                                    <input type="text" class="form-control" name="idCarta" id="idCartar">
                                    <br>

                                    <label for="producto">Elija Ticketera </label>
                                    <input type="text" class="form-control" name="pTicket" id="pTicket">
                                    <br><br>
